...
import com.slk.asistes.Data.SQLiteAssetHelper;
...
/**
 * Created by ViS on 22.10.15.
 */
public class Utils {

    public static final String INTENT_SEARCH_QUERY_EXTRA_ID = "search_query";
    public static final String INTENT_PRODUCT_CARD_EXTRA_ID = "product";
    ...
    public static ZipInputStream getFileFromZip(InputStream zipFileStream) throws IOException {
        ...
        while ((ze = zis.getNextEntry()) != null) {
            Logger.toConsole("extracting file: '" + ze.getName() + "'...");
            return zis;
        }
        return null;
    }
